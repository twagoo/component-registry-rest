package ru.inspirit.net
{
	...
	public class  MultipartURLLoader extends EventDispatcher
	{
		...
		private function doSend():void
		{
			...
			/*
			* Change patdui (MPI).
			* Set the contenttype in the request header otherwie we get an error like:
            *   'SecurityError: Error #2176: Certain actions, such as those that display a pop-up window, may only be invoked upon user interaction, for example by a mouse click or button press.'
            * See for instance: http://stackoverflow.com/questions/1270347/unexpected-flash-security-exception-when-using-urlloader for the explanation and solution.
			*/			
