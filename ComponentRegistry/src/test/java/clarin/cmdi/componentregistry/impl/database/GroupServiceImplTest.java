...
public class GroupServiceImplTest extends BaseUnitTest {
    ...
    protected BaseComponent makeTestProfile(String sid, boolean isPublic, long ownerId) {
    ...
    protected BaseComponent makeTestComponent(boolean isPublic,
	    long ownerId) {
	BaseComponent componentDescription = new BaseComponent();
	...
	BaseComponent profile = makeTestProfile("4567", false, 9999);
	...
	BaseComponent profile = makeTestProfile("4567", true, 9999);
	...
	BaseComponent profile = makeTestProfile("4567", false, user.getId()
		.longValue());
	...
	// Make a private profile that belongs to someone else
	BaseComponent componentDescription = makeTestComponent(false,
		9999);
	...
	// Make a public profile that belongs to someone else
	BaseComponent componentDescription = makeTestComponent(true,
		9999);
	...
	BaseComponent profileDescription= makeTestProfile("4567", false,
		user.getId().longValue());
	...
	BaseComponent profileDescription2= makeTestProfile("666", false,
		user.getId().longValue());
