...
public class RssCreatorDescriptionsTest {
    ...
    private void createTestDescription(BaseComponent desc, String creatorname,
    ...
    public void testMakeRss() throws JAXBException, UnsupportedEncodingException, IOException, ParseException {
        ...
        ProfileDescription desc1 = createTestProfileDescription("Useratti",
                "description-1", "groupname-1", "name-1", true, "2001-01-01", ProfileDescription.PROFILE_PREFIX+"p_1");
        ProfileDescription desc2 = createTestProfileDescription("Usereno",
                "description-2", "groupname-2", "name-2", false, "2001-01-02", ProfileDescription.PROFILE_PREFIX+"p_2");
        ProfileDescription desc3 = createTestProfileDescription("Userio",
                "description-3", "groupname-3", "name-3", true, "2001-01-03", ProfileDescription.PROFILE_PREFIX+"p_3");
        ...
        compareRssVsValues("description-1", baseURI + "?item=clarin.eu:cr1:p_p_1", DatesHelper.getRFCDateTime("2001-01-01"),
                instance.makeDescriptionTitle("name-1", "Useratti", "groupname-1"), items.get(0));
        compareRssVsValues("description-2", baseURI + "?item=clarin.eu:cr1:p_p_2", DatesHelper.getRFCDateTime("2001-01-02"),
                instance.makeDescriptionTitle("name-2", "Usereno", "groupname-2"), items.get(1));
        compareRssVsValues("description-3", baseURI + "?item=clarin.eu:cr1:p_p_3", DatesHelper.getRFCDateTime("2001-01-03"),
