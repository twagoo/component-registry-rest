...
public class Comment {
    ...
    /**
     * Compares two commments by their value as returned by {@link Comment#getCommentDate() }
     */
    public static final Comparator<Comment> COMPARE_ON_DATE = new Comparator<Comment>() {
	/**
	 * @return 1 if o11 is older than o2, returns -1 if o1 is younger than o2
	 */
	@Override
	public int compare(Comment o1, Comment o2) {

	    return (RssCreator.compareDateStrings(o1.getCommentDate(), o2.getCommentDate()));
	}
    };
}
