...
public class MDValidator implements Validator {
     ...
     * @param registry
     */
    public MDValidator(InputStream input, Component description, ComponentRegistry registry, ComponentRegistry userRegistry, ComponentRegistry publicRegistry, MDMarshaller marshaller) {
	this.input = input;
