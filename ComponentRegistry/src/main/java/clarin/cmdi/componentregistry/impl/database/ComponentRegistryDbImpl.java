...
public class ComponentRegistryDbImpl extends ComponentRegistryImplBase implements ComponentRegistry {
    ...
    @Override
    public Comment getSpecifiedCommentInProfile(String commentId) throws ComponentRegistryException {
        try {
    ...
    @Override
    public Comment getSpecifiedCommentInComponent(String commentId) throws ComponentRegistryException {
        try {
            return commentsDao.getSpecifiedCommentFromComponent(commentId);
        } catch (DataAccessException ex) {
